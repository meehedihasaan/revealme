    ...
    return (
      <div className="flex min-h-screen flex-col bg-background">
        <div className="flex items-center gap-3 border-b border-border px-4 py-3">
          ...
          <div className="h-10 w-10 rounded-[35%] bg-muted animate-pulse" />
        ...
        <button onClick={() => otherUser && navigate(`/user/${otherUser.user_id}`)} className="flex items-center gap-3 flex-1 min-w-0">
          <div className="relative shrink-0">
            {otherUser?.avatar_url ? (
              <img src={otherUser.avatar_url} alt="" className="h-10 w-10 rounded-[35%] object-cover" />
            ) : (
              <div className="flex h-10 w-10 items-center justify-center rounded-[35%] bg-secondary">
