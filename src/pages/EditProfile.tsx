      ...
      <div className="flex flex-col items-center -mt-12 pb-4">
        <div className="relative">
          <button onClick={() => fileRef.current?.click()}>
            {avatarPreview ? (
              <img src={avatarPreview} alt="Avatar" className="h-24 w-24 avatar-leaf object-contain border-4 border-background bg-secondary" />
            ) : (
              <div className="flex h-24 w-24 items-center justify-center avatar-leaf bg-secondary border-4 border-background">
