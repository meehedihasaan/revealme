                ...
                >
                  {u.avatar_url ? (
                    <img
                      src={u.avatar_url}
                      alt={u.username}
                      className="h-14 w-14 rounded-[30%] object-cover border-2 border-primary shadow-lg"
                    />
                  ) : (
                    <div className="flex h-14 w-14 items-center justify-center rounded-[30%] bg-secondary border-2 border-primary shadow-lg">
